...
# Конфигурация / Environment Variables (Railway үшін ыңғайлы)
...
async def keep_awake_task():
    """Railway-де контейнер ұйықтап қалмауы үшін қосымша цикл"""
    while True:
...
async def main():
    ...
    # Бұрын жұмыс істеп тұрған боттарды қайта қосу (Railway рестарт кезінде)
    # bots = await db.get_all_running_bots() -> Болашақта қосуға болады
